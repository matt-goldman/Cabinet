...
{
	/// <summary>
	/// Finds records matching the specified search terms and returns their data.
	...
	/// <returns>An enumerable of matching records</returns>
	/// <example>
	/// <code>
	...
	/// </code>
	/// </example>
	public static async Task<IEnumerable<T>> FindManyAsync<T>(
	...
	/// <param name="terms">Search terms to match (OR operation)</param>
	/// <returns>An enumerable of matching, filtered records</returns>
	/// <example>
	/// <code>
	...
	/// </code>
	/// </example>
	public static async Task<IEnumerable<T>> FindWhereAsync<T>(
		this IOfflineStore store,
		Func<T, bool> predicate,
		params string[] terms)
	{
