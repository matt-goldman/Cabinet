...
public interface IEncryptionProvider
{
    ...
    Task<byte[]> EncryptAsync(ReadOnlyMemory<byte> plaintext, string context, CancellationToken cancellationToken = default);
    ...
    Task<byte[]> DecryptAsync(ReadOnlyMemory<byte> ciphertext, string context, CancellationToken cancellationToken = default);
}
